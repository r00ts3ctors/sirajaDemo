                        ...
                        <div class="col m12" id="colres">
                            ...
                            <table class="bordered" id="tbl">
                                ...
                                if(mysqli_num_rows($query) > 0){
                                    ...
                                    if($row['admin'] == 1){
                                        $row['admin'] = '<div class="brown-text"><b>Super Admin</b></div>';
                                    } elseif($row['admin'] == 2){
                                        $row['admin'] = '<div class="green-text"><b>Kabid Rehabilitasi</b></div>'; 

                                    } elseif($row['admin'] == 3){
                                        $row['admin'] = '<div class="teal-text"><b>Klink (IPWL)</b></div>';

                                    } elseif($row['admin'] == 4){
                                        $row['admin'] = '<div class="purple-text"><b>Konselor/Dokter</b></div>';

                                    } else {
                                        $row['admin'] = 'Klien/Wali Paien';
