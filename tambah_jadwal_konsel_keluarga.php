                    ...
                    if(!preg_match("/^[a-zA-Z0-9.,_()%&@\/\r\n -]*$/", $isi_jad_keluarga)){
                        ...
                        if(!preg_match("/^[0-9 -]*$/", $batas_waktu)){
                            ...
                            echo '<script language="javascript">window.history.back();</script>';
                                ...
                                if(!preg_match("/^[a-zA-Z0-9.:,_()%&@\/\r\n -]*$/", $jam_acara)){
                                    $_SESSION['jam_acara'] = 'Form Jam hanya boleh mengandung karakter angka, huruf dan spasi atau yang dipilih';
                                    echo '<script language="javascript">window.history.back();</script>';
                                } else {

                                    $query = mysqli_query($config, "INSERT INTO tbl_jdl_kon_keluarga(isi_jad_keluarga,jam_acara,batas_waktu,id_surat,id_user)
                                        VALUES('$isi_jad_keluarga','$jam_acara','$batas_waktu','$id_surat','$id_user')");
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper blue-grey darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="#" class="judul"><i class="material-icons">update</i> Tambah Jadwal Konseling Keluarga</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            ...
                            <div class="input-field col s11 right">
                                <select class="validate" name="jam_acara" id="jam_acara" required>
                        ...
                        <div class="input-field col s12">
                            ...
                            <textarea id="isi_jad_keluarga" class="materialize-textarea validate" name="isi_jad_keluarga" required></textarea>
                                <?php
