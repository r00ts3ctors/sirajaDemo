                                                        ...
                                                        if (!preg_match("/^[a-zA-Z0-9., ]*$/", $nkode)) {
                                                            ...
                                                            if (!preg_match("/^[a-zA-Z0-9., -]*$/", $indeks)) {
                                                                ...
                                                                if (!preg_match("/^[0-9.-]*$/", $tgl_surat)) {
                                                                    ...
                                                                    tgl_diterima,file,keterangan,halo,id_user, klinik)
                                                                        VALUES('$no_agenda','$no_surat','$asal_surat','$nama','$tempat_lahir','$jenis_kelamin','$agama','$status_perkawinan','$pekerjaan','$kewarganegaraan','$isi','$nkode','$indeks','$tgl_surat',NOW(),'$nfile','$keterangan','$nofarras','$id_user', $klinik)");
        ...
        <div class="row jarak-form">
            ...
            <form class="col s12" method="POST" action="?page=tsm&act=add" enctype="multipart/form-data">
                    ...
                    <div class="input-field col s6">
                        ...
                        <div class="input-field col s11 right">
                            <select class=" validate" name="keterangan" id="keterangan" required>
                                ...
                                <option value="Suku Aceh">Suku Aceh</option>
                ...
                <div class="row">
                    ...
                    <div class="col 6">
                        <button type="submit" name="submit" class="btn-large blue waves-effect waves-light">SUBMIT<i class="material-icons">forward</i></button>
                    </div>
