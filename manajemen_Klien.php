...
if (empty($_SESSION['admin'])) {
                    ...
                    <div class="z-depth-1">
                        <nav class="secondary-nav">
                            <div class="nav-wrapper blue-grey darken-1">
                                <div class="col m7">
                                    <ul class="left">
                                        <li class="waves-effect waves-light hide-on-small-only"><a href="?page=tsm" class="judul"><i class="material-icons">loyalty</i> Data Klien Di Prov. KEPRI</a></li>
                                        <li class="waves-effect waves-light">
                                            <a href="?page=tsm&act=add"><i class="material-icons md-24">group_add</i> Tambah Klien Baru</a>
                                        </li>
                                    </ul>
                                </div>
    ...
    <?php
            if (isset($_REQUEST['submit'])) {
                ...
                echo '
                        ...
                        <table class="bordered" id="tbl">
                            <thead class="blue lighten-4" id="head">
                                <tr width="0%"><center>
                                    <div class="form blue lighten-4 black-text"><i class="material-icons md-36">filter_3</i> DATA MANAGEMEN KLIEN DI PROV. KEPULAUAN RIAU<i class="material-icons md-36 right">call_received</i>
                                    </div></center>
                                </tr>
                                <tr>
                ...
                if (mysqli_num_rows($query) > 0) {
                    ...
                    while ($row = mysqli_fetch_array($query)) {
                        ...
                        if ($_SESSION['admin'] == 1 || $_SESSION['admin'] == 2) {
                            echo '  <a class="btn small deep-purple accent-4 waves-effect waves-light tooltipped" data-position="left" data-tooltip="Pilih View untuk mengelola data Klien" href="?page=tsm&act=scr&id_surat=' . $row['id_surat'] . '"><i class="material-icons">update</i> Proses</a>
                            ...
                            echo '
                                            <a class="btn small deep-purple accent-4 waves-effect waves-light tooltipped" data-position="left" data-tooltip="Pilih View untuk mengelola data Klien" href="?page=tsm&act=scr&id_surat=' . $row['id_surat'] . '"><i class="material-icons">update</i> Proses</a>';
                        }
                        echo '
                                        </td>
                                    </tr>';
                ...
                if (isset($_REQUEST['SUBMIT-klinik'])) {
