                ...
                if(empty($pg)){
                            ...
                            <div class="z-depth-1">
                                <nav class="secondary-nav">
                                    <div class="nav-wrapper blue-grey darken-1">
                                        <div class="col m12">
                                            <ul class="left">
                                                <li class="waves-effect waves-light"><a href="?page=gsm" class="judul"><i class="material-icons">image</i> Galeri File Klien</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </nav>
                    ...
                    if(isset($_REQUEST['submit'])){
                        ...
                        if($_REQUEST['dari_tanggal'] == "" || $_REQUEST['sampai_tanggal'] == ""){
                            ...
                            if($_SESSION['admin'] == 3){
                                $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk WHERE tgl_diterima BETWEEN '$dari_tanggal' AND '$sampai_tanggal' AND id_user='".$_SESSION['id_user']."' ORDER By id_surat DESC LIMIT 10");
                            } else {
                        ...
                        echo '<!-- Row form Start -->
                            ...
                            <div class="row agenda">
                                <div class="col s12"> <p class="warna agenda">Galeri file Klien antara tanggal <strong>'.indoDate($dari_tanggal).'</strong> sampai dengan tanggal <strong>'.indoDate($sampai_tanggal).'</strong></p>
                                </div>
                            </div>';
                                ...
                                echo '<div class="col m12">
                                        <div class="card blue lighten-5">
                                            <div class="card-content notif">
                                                <span class="card-title lampiran"><center>Tidak ada file lampiran Klien  yang ditemukan</center></span>
                                            </div>
                                        </div>
                                    </div>';
                            } echo '
