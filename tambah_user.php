                ...
                if(!preg_match("/^[a-zA-Z0-9_]*$/", $username)){
                    ...
                    if(!preg_match("/^[a-zA-Z., ]*$/", $nama)){
                        ...
                        if(!preg_match("/^[a-zA-Z0-9.,()%@\/ -]*$/", $nip)){
                            $_SESSION['nipuser'] = 'Form Alamat hanya boleh mengandung karakter angka, spasi dan minus(-)';
                            echo '<script language="javascript">window.history.back();</script>';
                        } else {

                            if(!preg_match("/^[2-3-4-5]*$/", $admin)){
                                $_SESSION['tipeuser'] = 'Form Tipe User hanya boleh mengandung karakter angka 2 s/d 5';
                                echo '<script language="javascript">window.history.back();</script>';
                            } else {
                        ...
                        <div class="input-field col s6">
                            ...
                            <div class="input-field col s11 right">
                                <select class="browser-default validate" name="admin" id="admin" required>
                                    <option value="2">Kabid Rehabilitasi</option>
                                    <option value="3">Klink (IPWL)</option>
                                    <option value="4">Konselor/Dokter</option>
                                    <option value="5">Klien/Wali Paien</option>
                                </select>
                            </div>
                                <?php
