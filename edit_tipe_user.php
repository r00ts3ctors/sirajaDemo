            ...
            if($_REQUEST['id_user'] == $_SESSION['id_user']){
                ...
                if(isset($_REQUEST['submit'])){
                    ...
                    if($id_user == $_SESSION['id_user']){
                        ...
                        if(!preg_match("/^[2-3--4-5]*$/", $admin)){
                            $_SESSION['tipeuser'] = 'Form Tipe User hanya boleh mengandung karakter angka 2,3,4 atau 5';
                        ...
                        <div class="row jarak-form">
                            ...
                            <form class="col s12" method="post" action="?page=sett&sub=usr&act=edit">
                                ...
                                <div class="row">
                                    ...
                                    <div class="input-field col s6">
                                        ...
                                        <div class="input-field col s11 right">
                                            <select class="browser-default" name="admin" id="admin" required>
                                                <option value="2" <?php if ($row['admin'] == 2) { echo 'selected';} ?>>Kabid Rehabilitasi</option>
                                                <option value="3" <?php if ($row['admin'] == 3) { echo 'selected';} ?>>Klink (IPWL)</option>
                                                <option value="4" <?php if ($row['admin'] == 4) { echo 'selected';} ?>>Konselor/Dokter</option>
                        
                                                <option value="5" <?php if ($row['admin'] == 5) { echo 'selected';} ?>>Klien/Wali Paien</option>
                                            </select>
                                        </div>
                                            <?php
                                    ...
                                    <div class="input-field col s6">
                                        <i class="material-icons prefix md-prefix">text_fields</i>
                                        <input id="nip" type="text" value="<?php echo $row['nip'] ;?>" readonly class="grey-text">
