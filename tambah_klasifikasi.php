    ...
    if(empty($_SESSION['admin'])){
        ...
        if($_SESSION['admin'] != 1 AND $_SESSION['admin'] != 2){
            ...
            if(isset($_REQUEST['submit'])){
                ...
                if($_REQUEST['kode'] == "" || $_REQUEST['nama'] == "" || $_REQUEST['uraian'] == "" ||  $_REQUEST['kota'] == ""){
                        ...
                        if(!preg_match("/^[a-zA-Z0-9.,\/ -]*$/", $nama)){
                            ...
                            if(!preg_match("/^[a-zA-Z0-9.,()\/\r\n -]*$/", $uraian)){
                                ...
                                if($result > 0){
                                    ...
                                    $query = mysqli_query($config, "INSERT INTO tbl_klasifikasi(kode,nama,kota,uraian,id_user) VALUES('$kode','$nama','$kota','$uraian','$id_user')");

                                    if($query != false){
                                        $_SESSION['succAdd'] = 'SUKSES! Data Kategori Klinik berhasil ditambahkan';
                    ...
                    <div class="col s12">
                        <nav class="secondary-nav">
                            <div class="nav-wrapper blue-grey darken-1">
                                <ul class="left">
                                    <li class="waves-effect waves-light"><a href="?page=ref&act=add" class="judul"><i class="material-icons">bookmark</i> Tambah Kategori Klinik</a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
                                        ...
                                        <option value="">Pilih </option>
                                         <?php 
                                          ...
                                          while ($datax=mysqli_fetch_array($sql)) { ?>
                                           <option value="<?php echo $datax['id']?>"><?php echo $datax['nama_kota']?></option> 
                                         <?php
                                          }
                                         ?>
                                    </select>
