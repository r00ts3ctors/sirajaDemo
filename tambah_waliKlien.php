                        ...
                        if (!preg_match("/^[0-9 -]*$/", $batas_waktu)) {
                            ...
                            if (!preg_match("/^[a-zA-Z0-9.,()%@\/ -]*$/", $alamat_wali)) {
                                ...
                                if (!preg_match("/^[a-zA-Z0-9.,()%@\/ -]*$/", $no_telp)) {
                                    ...
                                    $query = mysqli_query($config, "INSERT INTO tbl_wali_Klien(nama_wali,no_telp,hubungan,tempat_lahir_wali,batas_waktu,pekerjaan_wali,halo, alamat_wali,nik,id_surat,id_user)
                                        VALUES('$nama_wali','$no_telp','$hubungan','$tempat_lahir_wali','$batas_waktu','$pekerjaan_wali', '$farras', '$nik','$alamat_wali','$id_surat','$id_user')");
            ...
            <form class="col s12" method="post" action="">
                ...
                <div class="row">
                    <div class="input-field col s12">
                        ...
                        <select name="haloklien" id="">
                            <option value="">- Pilih Klien -</option>
                            <?php
                            $queryKlient = mysqli_query($config, "SELECT id_surat, nama, no_surat, halo FROM tbl_surat_masuk");
                            while ($a = mysqli_fetch_array($queryKlient)) {
                                echo '<option value="' . $a['halo'] . '">' . $a['nama'] . '</option>';
                            }
