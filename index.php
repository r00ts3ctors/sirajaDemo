    ...
    <div class="col s11 m12">
        <div class="card purple darken-1">
            <div class="card-content white-text center">
                Hendak ke pasar beli celana <br>
                Jangan lupa beli lemari <br>
                Jika ingin terhidar dari virus corona <br>
                        ...
                        ?>
                            ...
                            <div class="col s12">
                                <div class="card-content">
                                    <h5 class="center" id="title">Aplikasi SIRAJA</h5>
...
<marquee onmouseover="this.stop()" onmouseout="this.start()">
    <div class="col s12 m4">
        <div class="card blue accent-2">
            <div class="card-content white-text center">
                Beli cabai beli terasi <br>
                Belinya di Pademangan <br>
                Virus corona harus dihidari <br>
