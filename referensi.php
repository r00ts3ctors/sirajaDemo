                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue-grey darken-1">
                                    <div class="col m7">
                                        <ul class="left">
                                            <li class="waves-effect waves-light hide-on-small-only"><a href="?page=ref" class="judul"><i class="material-icons">class</i> Kategori Klinik</a></li>';
                    ...
                    <div class="col m12" id="colres">
                        ...
                        echo '<div class="col m12" id="colres">
                                <table class="bordered" id="tbl">
                                    ...
                                    if($_SESSION['admin'] == 1 || $_SESSION['admin'] == 2 ){
                                         $qry = mysqli_query($config, "SELECT * FROM tbl_klasifikasi ORDER BY id_klasifikasi DESC LIMIT $curr, $limit");
                                    }
                                    if($_SESSION['admin']  == 3){
                                         $qry = mysqli_query($config, "SELECT * FROM tbl_klasifikasi WHERE id_user='".$_SESSION['id_user']."' ORDER BY id_klasifikasi DESC LIMIT $curr, $limit");
                                    }
                                    //script untuk menampilkan data
                                    ...
                                    if(mysqli_num_rows($qry) > 0){
                                        while($row = mysqli_fetch_array($qry)){
                                          ...
                                          <tr><td>'.$row['kode'].'</td>
                                                <td>'.$row['nama'].'</td>
                                                <td>'.id_to_name('tbl_kota', 'id', $row['kota'],'nama_kota').'</td>
                                                <td>'.$row['uraian'].'</td>
                                                <td>';
