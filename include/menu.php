    ...
    <div class="nav-wrapper">
        ...
        <ul class="center hide-on-med-and-down" id="nv">
            ...
            <?php if($_SESSION['admin'] == 1) { ?>
                <li><a class="button" href="?page=bp" data-activates="transaksi">BNNP</a></li>
                ...
                <ul id='pengaturan' class='dropdown-content'>
                    <li><a href="?page=sett">BNNK Batam</a></li>
                    <li><a href="?page=sett&sub=usr">BNNK Tanjungpinang</a></li>
                    <li><a href="?page=sett&sub=back">BNNK Karimun</a></li>
                </ul>
            ...
            <?php if($_SESSION['admin'] == 2) { ?>
                ...
                <li><a class="button" href="?page=asm" data-activates="agenda">Resume Klien</a></li>
                <li><a class="button" href="?page=gsm" data-activates="agenda">Berkas Klien</a></li>
