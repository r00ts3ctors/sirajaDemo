<?php
    ...
    if(empty($_SESSION['admin'])){
    	...
    	$query = mysqli_query($config, "SELECT * FROM tbl_asesmen WHERE id_asesmen='$id_asesmen'");
            ...
            while($row = mysqli_fetch_array($query)){
    		  ...
    		  echo '<!-- Row form Start -->
    				    ...
    				    <div class="col m12">
                            <div class="card">
                                ...
                                <div class="card-action">
        		                     <a href="?page=tsm&act=disp&id_surat='.$row['id_surat'].'&sub=del_a&submit=yes&id_asesmen='.$row['id_asesmen'].'" class="btn-large deep-orange waves-effect waves-light white-text">HAPUS <i class="material-icons">delete</i></a>
                	...
                	if(isset($_REQUEST['submit'])){
                		$id_asesmen = $_REQUEST['id_asesmen'];

                		$query = mysqli_query($config, "DELETE FROM tbl_asesmen WHERE id_asesmen='$id_asesmen'");
                		...
                		if($query == true){
                            ...
                            echo '<script language="javascript">
                                    window.location.href="./admin.php?page=tsm&act=disp&id_surat='.$row['id_surat'].'&sub=del_a&id_asesmen='.$row['id_asesmen'].'";
                                  </script>';
                		}
                	}
    		    }
